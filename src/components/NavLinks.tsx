...
export const ServicesDropdown = () => {
  ...
  return (
    <div className="relative group">
      <UniversalLink href={`/services`} className="flex items-center text-foreground/80 font-persian text-base hover:text-primary transition-colors">
        {t('common.services')}
        ...
        <div className="bg-white p-6 animate-zoom-in shadow-xl rounded-lg">
          <div className="grid grid-cols-2 gap-6">
            ...
            <div className="bg-primary/5 rounded-lg p-5">
              ...
              <UniversalLink
                href={`/wordpress-woocommerce-development`}
